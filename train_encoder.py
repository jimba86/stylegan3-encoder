...
from stylegan2.model import Encoder, Discriminator
...
def train(args, loader, encoder, generator, discriminator, e_optim, d_optim, device):
    ...
    if SummaryWriter and args.tensorboard:
        logger = SummaryWriter(logdir='./checkpoints')    
    ...
    for idx in pbar:
        ...
        if i % 10000 == 0:
            torch.save(
                ...
                f"checkpoints/encoder_{str(i).zfill(6)}.pt",
            )
